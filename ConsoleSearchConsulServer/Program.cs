...
namespace ConsoleSearchConsulServer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var allServerDic= allServer.Response;//这个是个dictionary 他的key是string类型 就是8500/ui上services的instance的id 就是服务实例id
            //例如7b04cd06-1bfb-4a3d-8e3b-c0e689237d74
        ...
        public async Task Do(ConsulClient consulClient)
        {
